...
interface DiscordAutoPopulatedSelectComponent extends DiscordNonActionRowComponent {
    type: DiscordComponentType.USER_SELECT | DiscordComponentType.ROLE_SELECT | DiscordComponentType.MENTIONABLE_SELECT;
...
export interface ContentDiscordWebhookPayload extends BaseDiscordWebhookPayload {
    content: string;
}
...
interface DiscordWebhookEmbed {
  ...
  fields?: { // Up to 25 field objects allowed
    name: string; // Max 256 characters
